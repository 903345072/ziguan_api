...
public class YlTrade {
    public static Object  entrust() {
        // 账户ID
        String accountId = "295";
        // 账户KEY
        String apiKey = "afc0f2ff941573d767a8f6a20f172ada";
        // 买入股票
        ...
        String res = YlTrade.urlPostMethod(url,toJson);
        return  res;
    }
